...
Процедура ОбработкаПроведения(Отказ,Режим)
	...
	Если ВыборкаКлиент.Количество()=0 Тогда
		ОбщегоНазначения.СообщитьПользователю("Дата документа не соответствует договору", ЭтотОбъект, "Договор", Договор, Истина);
		Возврат;
	КонецЕсли;
	...
	Если НЕ ЗначениеЗаполнено(ВыборкаКлиент.ПроцентОтРабот) Тогда
		ОбщегоНазначения.СообщитьПользователю("Специалисту не установлен процент оплаты от работ", ЭтотОбъект, "Специалист",Специалист, Истина);
		Возврат;
	КонецЕсли;

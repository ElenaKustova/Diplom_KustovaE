...
//Процедура
//	Параметры:
//		КомандыПечати - КомандаКомандногоИнтерфейса - 
...
Функция ПечатьАктОбОказанныхУслугахDOCX(МассивОбъектов)
	...
	ДвоичныеДанныеМакета = УправлениеПечатью.МакетПечатнойФормы(
		"Документ.РеализацияТоваровУслуг.ПФ_DOC_АктОбОказанныхУслугах");

...
//Доработка++
//	Параметры:
//		Ссылка - ОбъектМетаданныхДокумент - "РеализацияТоваровУслуг"
Процедура ВКМ_ВыполнитьАвтозаполнение(Ссылка) Экспорт
	...
	Запрос.Текст =
		...
		|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрНакопления.ВКМ_ВыполненныеКлиентуРаботы.Обороты(&ДатаНачала, &ДатаОкончания,, (Клиент,
		|			Договор) В
		|			(ВЫБРАТЬ
